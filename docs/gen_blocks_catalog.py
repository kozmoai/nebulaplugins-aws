...
from nebula.utilities.importtools import from_qualified_name, to_qualified_name

COLLECTION_SLUG = "nebula_aws"
...
def insert_blocks_catalog(generated_file):
    ...
    generated_file.write(
        ...
        "[saved through code](https://docs.nebula.io/concepts/blocks/#saving-blocks) "  # noqa
        "or [saved through the UI](https://docs.nebula.io/ui/blocks/).\n"
    )
