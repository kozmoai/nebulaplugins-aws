...
from nebula.blocks.abstract import SecretBlock
...
async def read_secret(
    ...
    Example:
        ...
        from nebula_aws import AwsCredentials
        from nebula_aws.secrets_manager import read_secret
...
async def update_secret(
    ...
    Example:
        ...
        from nebula import flow
        from nebula_aws import AwsCredentials
        from nebula_aws.secrets_manager import update_secret
...
async def create_secret(
    ...
    Example:
        ...
        from nebula import flow
        from nebula_aws import AwsCredentials
        from nebula_aws.secrets_manager import create_secret
...
async def delete_secret(
    ...
    Examples:
        ...
        from nebula import flow
        from nebula_aws import AwsCredentials
        from nebula_aws.secrets_manager import delete_secret
